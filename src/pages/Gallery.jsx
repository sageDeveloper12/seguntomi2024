          ...
          <div className="image__container" key={index}>
            {file.endsWith('.mp4') ? (
              <video width="320" height="240" controls>
                <source src={`https://event-api-4y3b.onrender.com/uploads/${file}`} type="video/mp4" />
                Your browser does not support the video tag.
              </video>
            ) : (
              <img src={`https://event-api-4y3b.onrender.com/uploads/${file}`} alt={`Uploaded media ${index}`} />
            )}
